...
namespace CSharpUtilsNETStandard.Utils
{
    ...
    public delegate void PrintLogDelegate(LogLevel level, [NotNull] string msg, [NotNull] string category);

    public delegate void PrintLogExceptionDelegate(LogLevel level, [NotNull] string msg, [CanBeNull] Exception exception, [NotNull] string category);

    public delegate void PrintLogDelegateEx(LogLevel level, [NotNull] string msg, [NotNull] object obj);

    public delegate void PrintLogExceptionDelegateEx(LogLevel level, [NotNull] string msg, [CanBeNull] Exception exception, [NotNull] object obj);
